...
%% path to database
% database_folder = 'ENTER YOUR PATH HERE!'; 
database_folder = 'O:\database\publication_database'; 
...
itaPrimPathBooth        = ita_merge(itaBoothPaths(3:4));
itaPrimPathLateral      = itaBoothPaths(3);
itaPrimPathOpposite     = itaBoothPaths(4);
itaSecPathBooth         = ita_merge(itaBoothPaths(5:6));
itaAFBPathBooth         = ita_merge(itaBoothPaths(1:2));
